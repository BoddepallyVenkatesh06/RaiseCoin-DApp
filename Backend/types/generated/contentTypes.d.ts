  ...
  attributes: {
    ...
    mobile: Attribute.BigInteger &
      Attribute.SetMinMax<
        ...
        string
      >;
    walletId: Attribute.String & Attribute.Required & Attribute.Unique;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiProfileProfile extends Schema.CollectionType {
  ...
  attributes: {
    ...
    email: Attribute.Email;
    investmentDetail: Attribute.JSON;
    InvestedValue: Attribute.BigInteger;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiStartupStartup extends Schema.CollectionType {
  ...
  attributes: {
    ...
    email: Attribute.Email;
    startupName: Attribute.String;
    previousFunding: Attribute.BigInteger;
    currentFunding: Attribute.BigInteger;
    noInvestors: Attribute.BigInteger;
    minInvestment: Attribute.BigInteger &
      Attribute.SetMinMax<
        {
          min: '0';
        },
    ...
    displayImg: Attribute.String;
    pricePerShare: Attribute.Integer;
    endDate: Attribute.Date;
    investorDetail: Attribute.JSON;
    investmentReceived: Attribute.BigInteger;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
